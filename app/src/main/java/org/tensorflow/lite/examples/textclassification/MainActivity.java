...
/** Main Activity la cual nos permite la interaccion con os usuarios. */
public class MainActivity extends AppCompatActivity {
  ...
  /** Envio de texto TextClassificationClient y clasificacion de mensajes. */
  ...
  /** Mustra la clasificacion de mensajes en pantalla. */
  private void showResult(final String inputText, final List<Result> results) {
    // Run on UI thread as we'll updating our app UI
    runOnUiThread(
        () -> {
          String textToShow = "Entrada: " + inputText + "\nSalida:\n";
